...
<em>Liz Tom and Jason Hamilton</em>

* This is a project to explore using authentication and the paperclip gem.  It allows users to sign up for a user name and share their photos.  The app will also allow them to tag other users.
